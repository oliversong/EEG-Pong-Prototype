# -----------------------------------------------------------------------------
# WARNING: GAME WILL NOT WORK UNLESS LSL STREAM IS STARTED BY OPENBCI GUI
# OpenBCI EEG Pong
# Language - Python
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_F6:
                    display_lsl_in_terminal(data_inlet)
            if event.type == pygame.KEYUP:
                left_change = 0
                right_change = 0
...
# data_inlet = create_lsl_inlet_manually()
# marker_inlet = create_lsl_markers()
ready()
board()
