...
class GUI(QtGui.QWidget):
    ...
    def set_layout(self, monitor=False):
        ...
        self.console.setStyleSheet(
            "font-family:Times;font-size:17px;color: rgb(255, 255, 255);background: rgb(0, 0, 0)")
...
class Board_Config_Widget(QtGui.QWidget):
    ...
    def set_channel_options_layout(self):
        ...
        self.channel_attributes = ['channel_label{}', 'power_entry{}', 'gain{}', 'input{}', 'bias{}', 'srb2{}',
                                   'srb1{}']
